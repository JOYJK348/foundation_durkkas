...
const ALL_MODULES = [
    { id: 'HR', label: 'HR', icon: '👥', color: 'text-blue-600', bgColor: 'bg-blue-50', borderColor: 'border-blue-100' },
    { id: 'PAYROLL', label: 'Payroll', icon: '💰', color: 'text-emerald-600', bgColor: 'bg-emerald-50', borderColor: 'border-emerald-100' },
    { id: 'ATTENDANCE', label: 'Attendance', icon: '📅', color: 'text-violet-600', bgColor: 'bg-violet-50', borderColor: 'border-violet-100' },
    { id: 'LMS', label: 'LMS', icon: '📚', color: 'text-amber-600', bgColor: 'bg-amber-50', borderColor: 'border-amber-100' },
    { id: 'CRM', label: 'CRM', icon: '🤝', color: 'text-rose-600', bgColor: 'bg-rose-50', borderColor: 'border-rose-100' },
    { id: 'FINANCE', label: 'Finance', icon: '📊', color: 'text-indigo-600', bgColor: 'bg-indigo-50', borderColor: 'border-indigo-100' },
];
