        ...
        <div className="p-4 md:p-8 space-y-6 max-w-4xl mx-auto">
            ...
            <div className="bg-white rounded-3xl p-6 shadow-sm border border-slate-100 relative overflow-hidden">
                ...
                <div className="mt-8 pt-6 border-t border-slate-50 flex items-center justify-between text-sm">
                    ...
                    <Link href="/hrms/employee/attendance" className="text-indigo-600 text-xs font-bold hover:underline">
                        View History
                    </Link>
                </div>
            </div>
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
                <Link href="/hrms/employee/leaves/new" className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all flex flex-col items-center gap-3 text-center group">
                ...
                <Link href="/hrms/employee/attendance" className="bg-white p-4 rounded-2xl border border-slate-100 shadow-sm hover:shadow-md transition-all flex flex-col items-center gap-3 text-center group">
            ...
            <div className="bg-white rounded-3xl border border-slate-100 shadow-sm overflow-hidden">
                <div className="p-6 border-b border-slate-50 flex items-center justify-between">
                    ...
                    <Link href="/hrms/employee/notifications" className="text-xs font-bold text-indigo-600 hover:text-indigo-700">View All</Link>
                </div>
