        ...
        <DashboardLayout>
                    ...
                    <div className="flex items-center gap-4">
                        ...
                        <div>
                            ...
                            <p className="text-sm text-slate-500 font-medium">
                                {isEmployee ? "Track and apply for leaves" : "Review and respond to branch leave requests"}
                            </p>
                        </div>
                    </div>
                    ...
                    <div className="flex gap-4">
                        {isEmployee && (
                            <button
                                ...
                                className="px-6 py-3 bg-indigo-600 text-white rounded-2xl text-xs font-black uppercase tracking-widest hover:bg-slate-900 transition-all shadow-xl shadow-indigo-100 flex items-center gap-2"
                            >
                ...
                <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
                    ...
                    <div className="space-y-6">
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-bold text-slate-400 uppercase tracking-widest">
                                                {isEmployee ? "My Pending" : "Active Requests"}
                                            </p>
                                    ...
                                    <div className="flex items-center gap-3">
                                        ...
                                        <div>
                                            <p className="text-[10px] font-bold text-emerald-600/60 uppercase tracking-widest">
                                                {isEmployee ? "Days Taken" : "Approved This Week"}
                                            </p>
                        ...
                        <div className="bg-gradient-to-br from-indigo-800 to-indigo-900 rounded-[40px] p-8 text-white shadow-xl shadow-indigo-100 flex flex-col items-center text-center">
                            ...
                            <p className="text-xs text-indigo-200/80 leading-relaxed font-medium mb-6">Ensure you follow the company standard leave guidelines. View policy handbook.</p>
            ...
            {showApplyModal && (
                <div className="fixed inset-0 z-[100] flex items-center justify-center bg-slate-900/60 backdrop-blur-sm p-4">
                    <div className="bg-white rounded-[40px] w-full max-w-xl p-10 overflow-hidden relative">
                        <button className="absolute top-8 right-8 text-slate-400 hover:text-slate-900" onClick={() => setShowApplyModal(false)}>
                            <XCircle className="w-8 h-8" />
                        </button>
                        <h2 className="text-3xl font-black text-slate-900 mb-2">Apply for Leave</h2>
                        <p className="text-slate-500 font-medium mb-8">Submit your request for coordination</p>

                        <div className="space-y-6">
                            <div className="grid grid-cols-2 gap-4">
                                <div className="space-y-2">
                                    <label className="text-xs font-black text-slate-400 uppercase tracking-widest">From Date</label>
                                    <input type="date" className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 text-sm font-bold" />
                                </div>
                                <div className="space-y-2">
                                    <label className="text-xs font-black text-slate-400 uppercase tracking-widest">To Date</label>
                                    <input type="date" className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 text-sm font-bold" />
                                </div>
                            </div>
                            <div className="space-y-2">
                                <label className="text-xs font-black text-slate-400 uppercase tracking-widest">Leave Type</label>
                                <select className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 text-sm font-bold">
                            ...
                            <div className="space-y-2">
                                ...
                                <textarea className="w-full bg-slate-50 border-none rounded-2xl px-6 py-4 text-sm font-bold h-32" placeholder="Describe the reason for your leave..."></textarea>
                            </div>
                            <button
                                onClick={() => {
                                ...
                                className="w-full py-5 bg-indigo-600 text-white rounded-3xl text-[10px] font-black uppercase tracking-widest"
                            >
                                Submit Request
                            </button>
                        </div>
